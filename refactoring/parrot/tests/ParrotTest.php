...
class ParrotTest extends TestCase
{
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::EUROPEAN->value, 0, new NorwegianBlueParams(0,false));
        self::assertSame(12.0, $parrot->getSpeed());
    }

    public function testSpeedOfAfricanParrotWithOneCoconut(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::AFRICAN->value, 1, new NorwegianBlueParams(0,false));
        self::assertSame(3.0, $parrot->getSpeed());
    }

    public function testSpeedOfAfricanParrotWithTwoCoconuts(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::AFRICAN->value, 2, new NorwegianBlueParams(0,false));
        self::assertSame(0.0, $parrot->getSpeed());
    }

    public function testSpeedOfAfricanParrotWithNoCoconuts(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::AFRICAN->value, 0, new NorwegianBlueParams(0,false));
        self::assertSame(12.0, $parrot->getSpeed());
    }

    public function testSpeedNorwegianBlueParrotNailed(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE->value, 0, new NorwegianBlueParams(1.5,true));
        self::assertSame(0.0, $parrot->getSpeed());
    }

    public function testSpeedNorwegianBlueParrotNotNailed(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE->value, 0, new NorwegianBlueParams(1.5,false));
        self::assertSame(18.0, $parrot->getSpeed());
    }

    public function testSpeedNorwegianBlueParrotNotNailedHighVoltage(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE->value, 0, new NorwegianBlueParams(4,false));
    ...
    public function testAnUnknownParrotWillWillThrownAnException(): void
    {
        ...
        $unknownParrot = new Parrot(-1, 0, new NorwegianBlueParams(0,false));
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE->value, 0, new NorwegianBlueParams(0,false));
