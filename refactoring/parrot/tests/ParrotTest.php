...
class ParrotTest extends TestCase
{
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::AFRICAN->value, 1, 0, false, new NorwegianBlueParams(0,false));
        self::assertSame(3.0, $parrot->getSpeed());
    }

    public function testSpeedOfAfricanParrotWithTwoCoconuts(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::AFRICAN->value, 2, 0, false, new NorwegianBlueParams(0,false));
        self::assertSame(0.0, $parrot->getSpeed());
    }

    public function testSpeedOfAfricanParrotWithNoCoconuts(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::AFRICAN->value, 0, 0, false, new NorwegianBlueParams(0,false));
        self::assertSame(12.0, $parrot->getSpeed());
    }

    public function testSpeedNorwegianBlueParrotNailed(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE->value, 0, 1.5, true, new NorwegianBlueParams(1.5,true));
        self::assertSame(0.0, $parrot->getSpeed());
    }

    public function testSpeedNorwegianBlueParrotNotNailed(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE->value, 0, 1.5, false, new NorwegianBlueParams(1.5,false));
        self::assertSame(18.0, $parrot->getSpeed());
    }

    public function testSpeedNorwegianBlueParrotNotNailedHighVoltage(): void
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE->value, 0, 4, false, new NorwegianBlueParams(4,false));
    ...
    public function testAnUnknownParrotWillWillThrownAnException(): void
    {
        ...
        $unknownParrot = new Parrot(-1, 0, 0, false, new NorwegianBlueParams(0,false));
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE->value, 0, 0, false, new NorwegianBlueParams(0,false));
